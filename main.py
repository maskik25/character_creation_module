...
def start_training(char_name, char_class):
    ...
    print('Введи команду: attack — атаковать.')
    print('defence - блокировать атаку.')
    print('special — использовать свою суперсилу.')
...
def choice_char_class():
    ...
    while approve_choice != 'y':
        ...
        if char_class == 'warrior':
            print('Воитель — дерзкий воин ближнего боя. Сильный и отважный.')
        if char_class == 'mage':
            print('Маг — находчивый воин дальнего боя. Обладает интеллектом.')
        if char_class == 'healer':
